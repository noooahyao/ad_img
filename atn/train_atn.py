...
model_checkpoint_map = {
    ...
    'resnet_v1_50': os.path.join('./train_model', 'resnet_24.ckpt'),
...
def non_target_graph(ori_x,x, y, i, x_max, x_min, grad):
  ...
  with slim.arg_scope(resnet_v1.resnet_arg_scope()):
    logits_res_v1_50, end_points_res_v1_50 = resnet_v1.resnet_v1_50(
      processed_imgs_res_v1_50, num_classes=num_classes,is_training=False,scope='resnet_v1_50',reuse=True)
...
def non_target_mi_fgsm_attack(input_dir, output_dir):
  ...
  with tf.Graph().as_default():
    ...
    with slim.arg_scope(resnet_v1.resnet_arg_scope()):
      logits_res_v1_50, end_points_res_v1_50 = resnet_v1.resnet_v1_50(
      train_img, num_classes=110,is_training=True,scope='resnet_v1_50')
    end_points_res_v1_50['logits'] = tf.squeeze(end_points_res_v1_50['resnet_v1_50/logits'], [1, 2])
    end_points_res_v1_50['probs'] = tf.nn.softmax(end_points_res_v1_50['logits'])
 
    predict = tf.argmax(end_points_res_v1_50['probs'],1)
    logits = end_points_res_v1_50['logits']    
    ...
    with tf.Session() as sess:
      ...
      for time in range(epoch_num):
        ...
        s2.save(sess=sess,save_path='./train_model/%s_%s.ckpt'%(model_type,time))
